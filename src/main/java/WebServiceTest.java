...
public class WebServiceTest {
    ...
    public static void soap() throws RemoteException {
        ...
        //或者使用WSParams进行参数设置
        // 然后，使用封装Call对象进行方法调用
        call.setTargetEndpointAddress("http://ip:9082/Third-api-getPiMasterInfo/1.0.0/ws2ws");
        call.setOperationName(new QName("http://ip/", "getPiMasterInfo"));
